...
public class KcmxActivity extends Activity implements AbsListView.OnScrollListener,AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData();
        if (datalist.size()>0){
            simp_adapter = new SimpleAdapter(this,getData(),R.layout.kcmx_item,
    ...
    private List<Map<String,Object>> getData(){
        ...
        while (cursor.moveToNext()){
            ...
            String kw = cursor.getString(cursor.getColumnIndex(SQLitConstant.KCMX_KW));
